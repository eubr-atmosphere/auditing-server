...
# Delete everthing between[client-machine] and [client-machine:vars]
sed -i 's/\[client-machine\].*\[client-machine:vars\]/[client-machine]\n\n[client-machine:vars]/' $ANSIBLE_HOSTS_FILE
...
# Run ansible
readonly DEPLOY_YML_FILE="deploy-auditing-client.yml"
